...
course_str_data = {
    ...
    'EWRT D01AS03Z': ('EWRT', '1A', '03Z', {'Z'}),
    'EWRT D01ASFY1': ('EWRT', '1A', 'FY1', {'Y', 'F'}),
    'EWRT D01AT01Z': ('EWRT', '1A', '01Z', {'Z'}),
    ...
    'KNES D09AX62Z': ('KNES', '9A', '62Z', {'Z'}),
    'KNES D15EX01Z': ('KNES', '15E', '01Z', {'Z'}),
    ...
    'NURS D93AL02F': ('NURS', '93A', '02F', {'F'}),
    'NURS D93PL01Y': ('NURS', '93P', '01Y', {'Y'}),
    'NUTR D062G02Z': ('NUTR', '62G', '02Z', {'Z'}),
    'P E D032F02Z': ('PE', '32F', '02Z', {'Z'}),
    'P E D32HX01Z': ('PE', '32H', '01Z', {'Z'}),
    'P E D32IX01Z': ('PE', '32I', '01Z', {'Z'}),
